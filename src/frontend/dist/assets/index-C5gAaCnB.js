...
function canMoveTo(wx, wy, radius) {
  return !isSolid(wx - radius, wy - radius) && !isSolid(wx + radius, wy - radius) && !isSolid(wx - radius, wy + radius) && !isSolid(wx + radius, wy + radius);
}
const HIDE_SPOTS = [
...
function castRays(ctx, px, py, angle, vpX, vpY, vpW, vpH, monsterWX, monsterWY, downdedSprites, flashOpacity) {
  ...
  const zBuffer = new Array(vpW).fill(Number.POSITIVE_INFINITY);
  for (let x = 0; x < vpW; x++) {
  ...
  for (const dp of downdedSprites) {
    ...
    const invDet2 = 1 / (planeX * dirY - dirX * planeY);
...
function drawPlayerHUD(ctx, player, teammate, vpX, vpY, _vpW, _vpH, playerIdx, hideSpots) {
  ...
  const statusColor = !player.alive ? "#333" : player.downed ? "#D24A4A" : player.hidden ? "#3DA86A" : "#E7EEF6";
  const statusText = !player.alive ? "DEAD" : player.downed ? `DOWNED  ${Math.ceil(player.downedTimer)}s` : player.hidden ? "HIDING" : "ALIVE";
...
function App() {
  ...
  const [canvasSize, setCanvasSize] = reactExports.useState({ w: 1200, h: 700 });
  const [jumpscareState, setJumpscareState] = reactExports.useState(null);
  const gsRef = reactExports.useRef(null);
  const animRef = reactExports.useRef(0);
  const screenRef = reactExports.useRef("start");
  const jumpscareTimerRef = reactExports.useRef(0);
  const shakeRef = reactExports.useRef({
    x: 0,
    y: 0,
    timer: 0
  });
  ...
  const draw = reactExports.useCallback(
    (ctx, gs, W, H) => {
      ...
      if (!p1.alive) {
        ...
        const p1Flash = p1.hidden ? 0.08 : p1.downed ? 0.3 : 1;
        castRays(
          ctx,
          p1.x,
          p1.y,
      ...
      if (!p2.alive) {
        ...
        const p2Flash = p2.hidden ? 0.08 : p2.downed ? 0.3 : 1;
        castRays(
          ctx,
          p2.x,
          p2.y,
      ...
      if (gs.notification) {
        ...
        const fadeAlpha = n.timer < 1.5 ? n.timer / 1.5 : 1;
        ctx.save();
  ...
  const drawStartScreen = reactExports.useCallback(
    (ctx, W, H, t) => {
      ...
      ctx.fillText(
        `© ${(/* @__PURE__ */ new Date()).getFullYear()}. Built with love using caffeine.ai`,
        cx,
        H - 18
      );
      ctx.textAlign = "left";
  ...
  const drawOverlayScreen = reactExports.useCallback(
    (ctx, W, H, gs, type) => {
      ctx.fillStyle = type === "victory" ? "rgba(4,10,20,0.94)" : "rgba(2,3,5,0.97)";
      ctx.fillRect(0, 0, W, H);
      ctx.textAlign = "center";
      if (type === "gameover") {
  ...
  const gameLoop = reactExports.useCallback(
    (timestamp) => {
      ...
      pulseRef.current = timestamp / 1e3;
      if (curScreen === "start") {
      ...
      const dt = gs.lastTimestamp === 0 ? 0 : Math.min((timestamp - gs.lastTimestamp) / 1e3, 0.1);
  ...
  reactExports.useEffect(() => {
    if (!(jumpscareState == null ? void 0 : jumpscareState.active)) return;
    const t = setTimeout(() => {
      setJumpscareState((prev) => prev ? { ...prev, phase: 1 } : null);
    }, 300);
    return () => clearTimeout(t);
  }, [jumpscareState == null ? void 0 : jumpscareState.active]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      ` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              width: "100%",
              height: "100%",
              animation: (jumpscareState == null ? void 0 : jumpscareState.active) && (jumpscareState.phase ?? 0) === 0 ? "jsContainerShake 0.09s infinite" : "none"
            },
        ...
        (jumpscareState == null ? void 0 : jumpscareState.active) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "90px", marginBottom: "28px" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            width: "68px",
                            height: "80px",
                            background: "radial-gradient(circle, #ff4040 0%, #cc0000 60%, #6b0000 100%)",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: [0, 1, 2, 3, 4, 5, 6].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            style: {
                              position: "absolute",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    fontWeight: 900,
                    color: "white",
                    textShadow: "0 0 50px rgba(255,255,255,0.9), 0 0 100px rgba(255,50,50,0.7)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    jumpscareState.playerIdx === 0 ? "PLAYER 1" : "PLAYER 2",
                    " — HOLD ON..."
                  ]
                }
              )
        ...
        screen !== "playing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#B23A3A" }, children: "DARK" }),
                    " HOUSE",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#A9B7C6", fontWeight: 400 }, children: "SURVIVAL" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
